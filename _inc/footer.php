<!-- start: FOOTER -->
		...
		<!-- start: JAVASCRIPTS REQUIRED FOR FORM ELEMENT -->
        ...
        <!-- end: JAVASCRIPTS REQUIRED FOR FORM ELEMENT -->
		...
		<!-- start: JAVASCRIPTS REQUIRED FOR PAGES -->
		...
		<!-- end : JAVASCRIPT REQUIRED FOR PAGES -->
