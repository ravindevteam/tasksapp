								...
								<div id="panel_overview" class="tab-pane fade in active">
									...
									<table class="table table-striped table-bordered table-hover tasks" id="assignedToMe">
										...
										<tbody>
											...
											?>
											<tr>
												<td><a href="taskDetails.php? k=<?php echo base64_encode($assignToMe['task_id']) ?>"><?php echo $assignToMe['title'] ?></a></td>
								...
								<div id="panel_edit_account" class="tab-pane fade">
									...
									<table class="table table-striped table-bordered table-hover tasks" id="assignedByMe">
										...
										<tbody>
											...
											?>
											<tr>
												<td><a href="taskDetails.php? k=<?php echo base64_encode($assignByMe['task_id']) ?>"><?php echo $assignByMe['title'] ?></a></td>
								...
								<div id="panel_projects" class="tab-pane fade">
									...
									<table class="table table-striped table-bordered table-hover tasks" id="Follower">
										...
										<tbody>
											...
											?>
											<tr>
												<td><a href="taskDetails.php? k=<?php echo base64_encode($follow['task_id']) ?>"><?php echo $follow['title'] ?></a></td>
